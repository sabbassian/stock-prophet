  ...
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="#" className="text-base text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                  Daily Picks
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="mt-4 text-base text-gray-600 dark:text-gray-400">
              Subscribe to our newsletter for the latest market insights and predictions.
            </p>
            <form className="mt-4">
              <div className="flex">
                <input
                  ...
                  className="input min-w-0 flex-1 py-2 px-3 rounded-l-md"
                />
                <button
                  type="submit"
                  className="btn-primary rounded-r-md rounded-l-none px-4"
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col sm:flex-row justify-between">
          <p className="text-base text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Stock Prophet. All rights reserved.
          </p>
        ...
        <div className="mt-8 text-center text-xs text-gray-500 dark:text-gray-400">
          <p>
            Disclaimer: Stock Prophet is for informational purposes only. Not financial advice. 
